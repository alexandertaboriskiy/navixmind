...
const ConversationSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'summarizedUpToId': PropertySchema(
      id: 2,
      name: r'summarizedUpToId',
      type: IsarType.long,
    ),
...
void _conversationSerialize(
  ...
  writer.writeLong(offsets[2], object.summarizedUpToId);
...
Conversation _conversationDeserialize(
  ...
  object.summarizedUpToId = reader.readLongOrNull(offsets[2]);
...
extension ConversationQueryFilter
  ...
  QueryBuilder<Conversation, Conversation, QAfterFilterCondition>
      summarizedUpToIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'summarizedUpToId',
      ));
    });
  }

  QueryBuilder<Conversation, Conversation, QAfterFilterCondition>
      summarizedUpToIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Conversation, Conversation, QAfterFilterCondition>
      summarizedUpToIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'summarizedUpToId',
        value: value,
...
extension ConversationQuerySortBy
  ...
  QueryBuilder<Conversation, Conversation, QAfterSortBy>
      sortBySummarizedUpToId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'summarizedUpToId', Sort.asc);
    });
  }

  QueryBuilder<Conversation, Conversation, QAfterSortBy>
      sortBySummarizedUpToIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'summarizedUpToId', Sort.desc);
    });
  }
...
extension ConversationQueryWhereDistinct
  ...
  QueryBuilder<Conversation, Conversation, QDistinct>
      distinctBySummarizedUpToId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'summarizedUpToId');
    });
  }
...
extension ConversationQueryProperty
  ...
  QueryBuilder<Conversation, int?, QQueryOperations>
      summarizedUpToIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'summarizedUpToId');
    });
  }
